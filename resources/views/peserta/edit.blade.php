...
<body>
    <h3 class="mb-4">Edit Peserta Pelatihan</h3>
    <form action="{{ route('peserta.update', $peserta->id) }}" method="POST">
        @csrf
        @method('PUT')
        <div class="row">
            <div class="col-md-6 mb-3"> <label class="form-label">Jurusan</label> <input type="text"
                    value="{{ $peserta->jurusan }}" name="jurusan" class="form-control"> </div>
            <div class="col-md-6 mb-3"> <label class="form-label">Gelombang</label> <input type="text"
                    value="{{ $peserta->gelombang }}" name="gelombang" class="form-control"> </div>
            <div class="col-md-6 mb-3"> <label class="form-label">Nama Lengkap</label> <input type="text"
                    value="{{ $peserta->nama_lengkap }}" name="nama_lengkap" class="form-control"> </div>
            <div class="col-md-6 mb-3"> <label class="form-label">NIK</label> <input type="text" name="nik"
                    value="{{ $peserta->nik }}" class="form-control"> </div>
            <div class="col-md-6 mb-3"> <label class="form-label">Kartu Keluarga</label> <input type="text"
                    value="{{ $peserta->kartu_keluarga }}" name="kartu_keluarga" class="form-control"> </div>
            ...
            <div class="col-md-6 mb-3"> <label class="form-label">Status</label>
                <select name="status" class="form-control">
                    ...
                    <option value="0" {{ $peserta->status == '0' ? 'selected' : '' }} ?>Tidak Aktif</option>
                </select>
            </div>
        </div>
        <button type="submit" class="btn btn-primary">Edit</button> <a href="{{ route('peserta.index') }}"
