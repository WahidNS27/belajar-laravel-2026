                    ...
                    <form action="{{ route('student.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-control" id="gender" name="gender" required>
                                ...
                                <option value="1" {{ old('gender') == 'Male' ? 'selected' : '' }}>Male
                                </option>
                                <option value="0" {{ old('gender') == 'Female' ? 'selected' : '' }}>Female
                                </option>
                            </select>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <img id="img-preview" src="{{ asset('assets/img/profile.png') }}" alt="" width="100">
                        </div>
