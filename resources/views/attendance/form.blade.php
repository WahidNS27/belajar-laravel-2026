...
<div class="alert alert-info border-0 shadow-sm mb-4 mt-4">
    <strong>Note:</strong>
    <p>You can mark all student as present by clicking yhe button above</p>
</div>
                ...
                <tr class="student-row">
                    ...
                    <td>
                        <input type="text" class="form-control note-input"
                            name="attendances[{{ $index }}][note]" placeholder="Optional.." disabled>
                    </td>
            ...
            @empty
                <tr>
                    <td colspan="7" class="text-center py-5 text-muted">
                        Data Student Not Found. <a href="{{ route('student.create') }}">Create Student</a> First
                    </td>
                </tr>
            @endforelse
        </tbody>
